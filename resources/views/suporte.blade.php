...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>Estamos aqui para ajudar! Entre em contato para assistência técnica ou dúvidas sobre nossos produtos.</p>
        </div>
        <div class="content-section">
            <h2>Assistência Técnica</h2>
            <p>Oferecemos suporte 24/7 para garantir que seu meca esteja sempre pronto para a batalha.</p>
        </div>
        <div class="content-section">
            <h2>Contato</h2>
            <p>Envie um email para suporte@mecasdetitanio.com ou ligue para 0800-123-456.</p>
        </div>
    </div>
    <div class="footer">
